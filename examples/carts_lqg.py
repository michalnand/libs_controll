...
'''
controller   = LibsControll.fit_controller(LibsControll.LQG, plant, steps = 400, amplitudes=[0, 1], loss_weight=[0, 1], dt=dt, batch_size=batch_size)
...
LibsControll.plot_controll_output(t_trajectory, u_trajectory, y_req_trajectory, y_trajectory, ["force [N]"], ["position 1 [m]", "position 2 [m]"], "images/carts_lqq.png")
