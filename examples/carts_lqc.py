...
'''
t_trajectory, y_req_trajectory, y_trajectory, u_trajectory  = LibsControll.step_response_closed_loop(controller, plant, amplitudes=[0, 1, 0, 0], dt=dt)
